...
def upgrade():
    ...
    op.alter_column('document', 'status', type_=tmp_document_type, postgresql_using="status::text::tmp_documentstatus")
    ...
    op.alter_column('document', 'status', type_=new_document_type, postgresql_using="status::text::documentstatus")
    ...
    op.alter_column('signaturerequest', 'status', type_=tmp_request_type, postgresql_using="status::text::tmp_signaturerequeststatus")
    ...
    op.alter_column('signaturerequest', 'status', type_=new_request_type, postgresql_using="status::text::signaturerequeststatus")
...
def downgrade():
    ...
    op.alter_column('document', 'status', type_=old_document_type, postgresql_using="status::text::documentstatus")
    # Drop the temporary document status type
    tmp_document_type.drop(op.get_bind(), checkfirst=False)
    ...
    op.alter_column('signaturerequest', 'status', type_=old_request_type, postgresql_using="status::text::signaturerequeststatus")
    # Drop the temporary signature request status type
